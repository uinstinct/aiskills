...
When the user asks to scaffold or create a new local skill (e.g. "run skill-new with name <name>", "create a new skill called <name>"), invoke the `skill_new.py` script with the user-supplied arguments.
...
where `<ARGUMENTS>` is the skill name the user provided, plus any optional flags they mentioned.
